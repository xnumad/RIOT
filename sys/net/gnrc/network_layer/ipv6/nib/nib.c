                                      ...
                                      gnrc_ipv6_nib_nc_t *nce)
{
    ...
    do {    /* XXX: hidden goto ;-) */
        ...
        if (((node != NULL) && (node->info & GNRC_IPV6_NIB_NC_INFO_AR_STATE_TENTATIVE))
            /* "Tentative NCEs MUST NOT be used to
             * determine on-link status of the registered nodes."
             * - https://datatracker.ietf.org/doc/html/rfc6775#section-6.5.4
             */
            || _on_link(dst, &iface)) {
                            ...
                            const ndp_rtr_adv_t *rtr_adv, size_t icmpv6_len)
{
    ...
    if ((dr != NULL) && gnrc_netif_is_6ln(netif) &&
        ...
        /* Register link-local addresses first
         * https://datatracker.ietf.org/doc/html/rfc8505#section-5.6 */
